...
insert into information values('amit',1988/04/03,'Reacherch',45000,'Mumbai','800002'),
...
update information set salary=(select salary from information where emp_id=100) where emp_id=101

update information set salary=(select max(salary)+1000 from information) where emp_id=100 

select distinct salary from information
